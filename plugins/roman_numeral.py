...
class Plugin:
    ...
    def __convert_roman_numeral(self, num):
        ...
        if num >= 1000:
            num -= 1000
            return roman_numerals[13] + \
                Plugin.__convert_roman_numeral(self, num)
        elif num >= 500:
            num -= 500
            return roman_numerals[12] + \
                Plugin.__convert_roman_numeral(self, num)
        elif num >= 400:
            num -= 400
            return roman_numerals[11] + roman_numerals[12] + \
                Plugin.__convert_roman_numeral(self, num)
        elif num >= 100:
            num -= 100
            return roman_numerals[11] + \
                Plugin.__convert_roman_numeral(self, num)
        elif num >= 90:
            num -= 90
            return roman_numerals[9] + roman_numerals[11] + \
                Plugin.__convert_roman_numeral(self, num)
        elif num >= 50:
            num -= 50
            return roman_numerals[10] + \
                Plugin.__convert_roman_numeral(self, num)
        elif num >= 40:
            num -= 40
            return roman_numerals[9] + roman_numerals[10] + \
                Plugin.__convert_roman_numeral(self, num)
        elif num > 10:
            num -= 10
            return roman_numerals[9] + \
                Plugin.__convert_roman_numeral(self, num)
        elif num > 0:
