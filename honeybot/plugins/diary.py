            ...
            if info['command'] == 'PRIVMSG' and msgs[0] == '.diary':
                ...
                if name not in owner:
                    ...
                    if msgs[1].lower() == "delete":
                        ...
                        if len(msgs) != 3:
                            methods["send"](info["address"],"Invalid Input. Try .diary show 21-03-2020")
                        else:
                        ...
                        if len(msgs) > 2:
                            flag = Plugin.record(self,time,msgs[2:]) #will return true if there was already an entry
                            if flag:
                                methods["send"](info["address"],"Text added to diary entry successfully!")
                            else:
                                methods["send"](info["address"],"Diary entry created successfully!")
                        else:
                        ...
                        methods["send"](info["address"],".diary show today or .diary show 01-01-2000")
