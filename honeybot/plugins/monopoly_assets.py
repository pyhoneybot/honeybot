...
chance_deck = [
        ...
        {"Advance to St. Charles Place. If you pass Go, collect $200":move()},
        {"Your building and loan matures. Collect $150":earn()},
        {"Advance token to nearest utility. If Unowned you may buy it from the bank. If owned throw dice and pay owner ten times the amount thrown.":util(amount_thrown)},
