...
chance_deck = [
               {"You have been elected chairman of the board, pay each player $50":[0,(150)]]},
               {"Take a ride on the reading, if you pass GO collect $200":[1,()]]},
               {"Take a walk on the board walk, advance token to board walk":[2,()]]},
               ...
               {"Advance to Illinois Ave":[8,()]},
               {"Pay poor tax of $15":[9,(15)]},
               {"Make general repairs on all your property. For each house pay $25, for each hotel $100":[10,(25,100)]},
               {"Advance to St. Charles Place. If you pass Go, collect $200":[11,()]},
               {"Your building and loan matures. Collect $150":[7,(150)]},
               {"Advance token to nearest utility. If Unowned you may buy it from the bank. If owned throw dice and pay owner ten times the amount thrown.":[12,()]},
               {"Go back 3 spaces":[13,()]}
              ].shuffle()
