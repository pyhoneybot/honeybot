    ...
    def scrape(self,country):
        ...
        if country == "global":
            ...
            for c in most_affected:
                ...
                total_cases = c[1]
                deaths = c[2]
                string = country +" has " + total_cases + " confirmed cases that have led to " + deaths +" deaths. RIP \n"
                msg += string
            return msg
        else:
            print(country)
            ...
            for index in range(0,len(data)-9,9):
                ...
                if data[index].text == country:
                    ...
                    msg = "The latest coronavirus pandemic figures as of "+today+" for "+name+" show"+\
                    " that there are currently "+cases+" cases of coronavirus in "+name+"."
                    if recovered != " ":
                        msg+= " Of these "+ recovered +" have recovered. "
                    else:
                        msg+= " None have recovered yet. "
                    if deaths != " ":
                        msg+= "Unfortunately, "+ deaths.strip() + " patients in "+name+" have died as a "+\
                              "result of the coronavirus pandemic. May they rest in peace."
                    else:
